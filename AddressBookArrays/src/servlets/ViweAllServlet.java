...
public class ViweAllServlet extends HttpServlet {
            ...
            try {
                ...
                if (process.viweAll(filename).length < 1) {
                    ...
                    for (int i = 0; i < process.viweAll(filename).length; i++) {
                        out.println("<tr><td>" + ar++ + "</td><td><a href = \"/user?name=" + arrindex++ + "\">" + process.viweAll(filename)[i].getFirstName() + "</a></td><td>" + process.viweAll(filename)[i].getLastName() + "</td><td>" + process.viweAll(filename)[i].getEmail() + "</td><td>" + process.viweAll(filename)[i].getPhone() + "</td></tr>");
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
