...
public class ContactSortedFirstNameServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (b == null || !b) {
            ...
            try {
                for (int i = process.sortedFirstName(filename).length - 1; i >= 0; i--) {
                    out.println("<tr><td>" + number++ + "</td><td><a href = \"/search?Search= " + process.sortedFirstName(filename)[i] + "\">" + process.sortedFirstName(filename)[i] + "</a></td><td></td><td></td><td></td></tr>");
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
