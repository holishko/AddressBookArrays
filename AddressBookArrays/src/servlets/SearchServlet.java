...
public class SearchServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (b == null || !b) {
            ...
            String objectsearch = inputString.trim().replace(" ", " ");
            ...
            try {
                for (Contact u : process.viweAll(filename)) {
                    if (u.getFirstName().equalsIgnoreCase(objectsearch) || u.getLastName().equalsIgnoreCase(objectsearch) || u.getEmail().equalsIgnoreCase(objectsearch) || u.getPhone().equalsIgnoreCase(objectsearch) || u.getBirthday().equalsIgnoreCase(objectsearch) || u.getMobile().equalsIgnoreCase(objectsearch) || u.getWorkphone().equalsIgnoreCase(objectsearch) || u.getFax().equalsIgnoreCase(objectsearch) || u.getCompany().equalsIgnoreCase(objectsearch) || u.getDepartament().equalsIgnoreCase(objectsearch) || u.getPozition().equalsIgnoreCase(objectsearch) || u.getCountry().equalsIgnoreCase(objectsearch) || u.getState().equalsIgnoreCase(objectsearch) || u.getCity().equalsIgnoreCase(objectsearch) || u.getZip().equalsIgnoreCase(objectsearch)) {
                        out.println("<tr><td>" + number++ + "</td><td><a href = \"/user?name=" + arr + "\">" + u.getFirstName() + "</a></td><td>" + u.getLastName() + "</td><td>" + u.getEmail() + "</td><td>" + u.getPhone() + "</td></tr>");
                    }
                    arr++;
                }
            } catch (Exception e) {
